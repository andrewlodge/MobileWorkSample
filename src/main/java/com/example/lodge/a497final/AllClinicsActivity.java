...
public class AllClinicsActivity extends AppCompatActivity {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final SimpleAdapter clinicAdapter = new SimpleAdapter(
                            ...
                            new String[]{"name", "openTime", "closeTime", "location", "procedures"},
                            new int[]{R.id.clinic_name, R.id.open_time, R.id.close_time, R.id.clinic_location, R.id.procedures});
