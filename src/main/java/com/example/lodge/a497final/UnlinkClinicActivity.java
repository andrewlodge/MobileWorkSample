...
public class UnlinkClinicActivity extends AppCompatActivity {

    private static final String TAG = "UnlinkClinicActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unlink_clinic);
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final SimpleAdapter unlinkClinicAdapter = new SimpleAdapter(
                            UnlinkClinicActivity.this,
                            clinics,
                            R.layout.unlink_clinic_item,
                            new String[]{"name", "openTime", "closeTime", "location", "procedures", "id"},
                            new int[]{R.id.unlink_name, R.id.unlink_open, R.id.unlink_close, R.id.unlink_location, R.id.unlink_procedures_display, R.id.unlink_id});
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ((ListView)findViewById(R.id.list_unlink_clinic)).setAdapter(unlinkClinicAdapter);
                        }
                    });
        ...
        // OK after here
        final ListView lv = (ListView) findViewById(R.id.list_unlink_clinic);
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent j=new Intent(UnlinkClinicActivity.this, UnlinkProcedureActivity.class);
