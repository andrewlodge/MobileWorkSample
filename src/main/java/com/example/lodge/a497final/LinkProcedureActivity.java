...
public class LinkProcedureActivity extends AppCompatActivity {

    private static final String TAG = "LinkProcedureActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_link_procedure);
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final SimpleAdapter linkProcedureAdapter = new SimpleAdapter(
                            LinkProcedureActivity.this,
                            procedures,
                            R.layout.link_procedure_item,
                            new String[]{"name", "duration", "cost", "operator", "id"},
                            new int[]{R.id.link_procedure_name, R.id.link_procedure_duration, R.id.link_procedure_cost, R.id.link_procedure_operator, R.id.link_procedure_id});
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ((ListView)findViewById(R.id.list_link_procedure)).setAdapter(linkProcedureAdapter);
                        }
                    });
        ...
        // OK after here
        final ListView lv = (ListView) findViewById(R.id.list_link_procedure);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                linkOkHttpClient.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        Intent next_activity =new Intent(LinkProcedureActivity.this, MainActivity.class);
