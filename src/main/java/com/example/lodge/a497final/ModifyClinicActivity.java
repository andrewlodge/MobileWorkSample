...
public class ModifyClinicActivity extends AppCompatActivity {

    private static final String TAG = "ModifyClinicActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final SimpleAdapter modifyClinicAdapter = new SimpleAdapter(
                            ModifyClinicActivity.this,
                            clinics,
                            R.layout.modify_clinic_item,
                            new String[]{"name", "openTime", "closeTime", "location", "id"},
                            new int[]{R.id.modify_name, R.id.modify_open, R.id.modify_close, R.id.modify_location, R.id.modify_id});
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ((ListView)findViewById(R.id.list_modify_clinics)).setAdapter(modifyClinicAdapter);
                        }
                    });
        ...
        // OK after here
        final ListView lv = (ListView) findViewById(R.id.list_modify_clinics);
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent j=new Intent(ModifyClinicActivity.this, ModifyClinicFormActivity.class);
