...
public class DeleteClinicActivity extends AppCompatActivity {
    ...
    private static final String TAG = "AllClinicsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final SimpleAdapter deleteClinicAdapter = new SimpleAdapter(
                            DeleteClinicActivity.this,
                            clinics,
                            R.layout.delete_clinic_item,
                            new String[]{"name", "openTime", "closeTime", "location", "id"},
                            new int[]{R.id.clinic_name, R.id.open_time, R.id.close_time, R.id.clinic_location, R.id.clinic_id});
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ((ListView)findViewById(R.id.list_delete_clinics)).setAdapter(deleteClinicAdapter);
                        }
                    });
        ...
        // OK after here
            final ListView lv = (ListView) findViewById(R.id.list_delete_clinics);
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                // Start the delete call here
                    ...
                    String deleteUrlString = "https://final-197620.appspot.com/clinic/" + clinic_identifier;
                    ...
                    deleteOkHttpClient.newCall(request).enqueue(new Callback() {
                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                            ...
                            Intent next_activity =new Intent(DeleteClinicActivity.this, MainActivity.class);
